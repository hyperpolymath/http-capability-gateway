...
// Replace http-capability-gateway, Http Capability Gateway — See README.adoc for details., just run, Http Capability Gateway started successfully. with actuals
= http-capability-gateway — Quick Start for Users
:toc:
:toclevels: 2

== What is http-capability-gateway?

Http Capability Gateway — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./http-capability-gateway-portable
----
...
[source]
----
Http Capability Gateway started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/http-capability-gateway/wiki
