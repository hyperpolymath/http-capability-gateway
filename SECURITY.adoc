...
[arabic]
. Navigate to
https://github.com/hyperpolymath/http-capability-gateway/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/http-capability-gateway+`) and all
its code
...
https://github.com/hyperpolymath/http-capability-gateway/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/http-capability-gateway/discussions[GitHub
Discussions]
...
_Thank you for helping keep Http Capability Gateway and its users safe._
🛡️
