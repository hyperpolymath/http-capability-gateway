{
  description = "http-capability-gateway - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 http-capability-gateway development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P http-capability-gateway.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/http-capability-gateway $out/bin/  # Rust
            # cp bin/http-capability-gateway $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/http-capability-gateway";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-http-capability-gateway" {
